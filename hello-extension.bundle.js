...
var hello_extension_default = new ExtensionBuilder().withVersion("1.0.0").addBlock({
  type: "hello-block",
  label: "\u{1F44B} Hello Block",
  icon: '<svg width="20" height="20"><text x="0" y="15" font-size="16">\u{1F44B}</text></svg>',
  create() {
    return {
      html: `<div class="hello-block">Hello from Stripo UI Extensions!</div>`,
      css: `.hello-block {
          padding: 10px;
          background: #007bff;
          color: white;
...
export {
  hello_extension_default as default
};
